#pragma checksum "C:\ProjectsC#\APIDashboard\Views\PreProduction\_PopupSBM.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "7cdb270470e91bf1867d14110d17df497e025f9a"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"7cdb270470e91bf1867d14110d17df497e025f9a", @"/Views/PreProduction/_PopupSBM.cshtml")]
			...
			<ul>
				<li>
					<p class=""content-ul-li-SBM"">
						<b class=""green"">OK</b>: All informations can be get by our API method and informations are available from your seller's zone.
					</p>
				</li>
				<li>
					<p class=""content-ul-li-SBM"">
						<b class=""orange"">NOK</b>: Some issue has been detected like a non update of offers in your Products catalog page of your seller's zone but informations can be g");
            WriteLiteral(@"et from API method.
					</p>
				</li>
				<li>
					<p class=""content-ul-li-SBM"">
						<b class=""red"">KO</b>: An issue has been detected about this API method and our team are mobilized to resolved this problem. Some API method are down. No informations are reported.
					</p>
				</li>
			</ul>
		</div>
...
<script>
    ...
    $(popupSBM).find(""button[name=closeSBM]"").on(""click"", fun");
